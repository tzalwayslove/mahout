...
import com.rcd.model.recommender.MyRandomRecommender;
...
public class RecomendServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(recommendType.equals("userBased")){//基于用户
			...
			MyRandomRecommender msor = new MyRandomRecommender();
			//拿到推荐的电影
			recommendation = msor.myRandomRecommender(userID,size);
		}
